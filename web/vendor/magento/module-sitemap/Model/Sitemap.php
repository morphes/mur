...
//        return '<url>' . $row . '</url>';
	if (    strpos( $url, "series" ) !== false ||
                strpos( $url, "stock-check" ) !== false ||
                strpos( $url, "mwoc" ) !== false ||
                strpos( $url, "datasheet" ) !== false ||
                strpos( $url, "rohs20" ) !== false ||
                strpos( $url, "3d-download" ) !== false ||
                strpos( $url, "contact") !== false ||
                strpos( $url, "request") !== false ||
                strpos( $url, "log-in" ) !== false  ||
                strpos( $url, "applications-global" ) !== false ||
                strpos( $url, "support-1" ) !== false ||
                strpos( $url, "design-tools" ) !== false ||
                strpos( $url, "about-murata" ) !== false ||
                strpos( $url, "my-murata" ) !== false ||
                strpos( $url, "download" ) !== false ||
                strpos( $url, "micro-dc-dc-converter" ) !== false ||
                strpos( $url, "other-products" ) !== false )  {
                return;
        }
        else {
                return '<url>' . $row . '</url>';
