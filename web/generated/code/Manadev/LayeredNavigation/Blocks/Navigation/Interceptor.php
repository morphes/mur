<?php
namespace Manadev\LayeredNavigation\Blocks\Navigation;

/**
 * Interceptor class for @see \Manadev\LayeredNavigation\Blocks\Navigation
 */
class Interceptor extends \Manadev\LayeredNavigation\Blocks\Navigation implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Manadev\LayeredNavigation\Engine $engine, \Manadev\LayeredNavigation\UrlGenerator $urlGenerator, \Manadev\LayeredNavigation\Configuration $config, \Manadev\Core\Helpers\LayoutHelper $layoutHelper, array $data = array())
    {
        $this->___init();
