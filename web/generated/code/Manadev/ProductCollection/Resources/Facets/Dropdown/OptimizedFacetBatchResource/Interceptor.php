<?php
namespace Manadev\ProductCollection\Resources\Facets\Dropdown\OptimizedFacetBatchResource;

/**
 * Interceptor class for @see \Manadev\ProductCollection\Resources\Facets\Dropdown\OptimizedFacetBatchResource
 */
class Interceptor extends \Manadev\ProductCollection\Resources\Facets\Dropdown\OptimizedFacetBatchResource implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\ResourceModel\Db\Context $context, \Manadev\ProductCollection\Factory $factory, \Magento\Store\Model\StoreManagerInterface $storeManager, \Manadev\ProductCollection\Configuration $configuration, \Manadev\ProductCollection\Resources\HelperResource $helperResource, \Manadev\Core\Helpers\DbHelper $dbHelper, \Manadev\ProductCollection\FacetSorter $sorter, \Manadev\ProductCollection\Resources\Facets\Dropdown\StandardFacetResource $standardFacetResource, \Manadev\Core\Resources\TemporaryResource $temporaryResource, $resourcePrefix = null)
    {
        $this->___init();
        parent::__construct($context, $factory, $storeManager, $configuration, $helperResource, $dbHelper, $sorter, $standardFacetResource, $temporaryResource, $resourcePrefix);
    }
