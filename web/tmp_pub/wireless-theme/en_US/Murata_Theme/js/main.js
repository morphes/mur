function foo(a, b) {
    var c = !0;
    return !window.console || b && !c ? !1 : (void 0 === a && (a = "o_O"), "object" == typeof a ? (console.log("[" + (new Date).toUTCString().split(" ")[4] + "] object:"), console.dir(a)) : console.log("[" + (new Date).toUTCString().split(" ")[4] + "] " + a), void 0)
}
function setDropdownHeight() {
    foo("setDropdownHeight", 1);
    var a = $(".page-header > .container > .nav.nav-pills"), b = a.clone();
    b.attr("id", "--tempnav--"), b.css({
        visibility: "hidden",
        position: "absolute",
        width: "100%",
        left: "-99999px"
    }).prependTo($(".page-header .container"));
    var c = b.find(".dropdown-menu"), d = 0;
    c.each(function () {
        var a = parseInt($(this).css("min-height"));
        $(this).parent().find("*").each(function () {
            $(this).show()
        }), $(this).find("dl, .dropdown-blocks").each(function () {
            var b = $(this).outerHeight(!0) + 86;
            b > a && (a = b)
        }), a > d && (d = a)
    }), b.remove(), a.find(".dropdown-menu").css("min-height", d)
}
function closeNav() {
    foo("closeNav", 1), Modernizr.touch && $('<li class="close">x</li>').insertAfter("[id$=primary-nav] li.dropdown").bind("touchstart", function (a) {
        a.preventDefault(), $(a.target).css("display", "block"), $(a.target).css("visibility", "hidden")
    }).bind("touchend", function (a) {
        $(a.target).css("display", ""), $(a.target).css("visibility", "")
    })
}
!function (a) {
    a.fn.outline = function (a) {
        return this.css({outline: "5px solid " + (a ? a : "rgba(255,20,147,0.5)")}), this
    }
}(jQuery), function (a) {
    a.fn.clickable = function () {
        return this.contents().unwrap().parent().css({cursor: "pointer"}).on("click", function () {
    ...
    var d = c.url;
    if (d.indexOf("/modules/")) {
        var e = d.lastIndexOf("/") + 1, f = d.lastIndexOf("."), g = "#" + c.url.slice(e, f);
        primp.loadComplete(g)
    }
}), function (a) {
    var b = a('[data-scroll="scrollToTop"]');
    a(b).click(function () {
    ...
    a.fn.addBack = a.fn.addBack || a.fn.andSelf, a.fn.extend({
        actual: function (b, c) {
            ...
            var d, e, f = {absolute: !1, clone: !1, includeMargin: !1}, g = a.extend(f, c), h = this.eq(0);
            if (g.clone === !0) d = function () {
                ...
                var i, j = [], k = "";
                d = function () {
                    i = h.parents().addBack().filter(":hidden"), k += "visibility: hidden !important; display: block !important; ", g.absolute === !0 && (k += "position: absolute !important; "), i.each(function () {
                        var b = a(this);
                        j.push(b.attr("style")), b.attr("style", k)
                    })
                }, e = function () {
                    i.each(function (b) {
                        var c = a(this), d = j[b];
    ...
    var h, i, j = "placeholder" in b.createElement("input"), k = "placeholder" in b.createElement("textarea"), l = c.fn,
        m = c.valHooks, n = c.propHooks;
    ...
    function go_complementAutoObject(a, b) {
        return is_function(b.button) && (b.button = b.button.call(a)), is_string(b.button) && (b.button = jQuery(b.button)), is_boolean(b.play) || (b.play = !0), is_number(b.delay) || (b.delay = 0), is_undefined(b.pauseOnEvent) && (b.pauseOnEvent = !0), is_boolean(b.pauseOnResize) || (b.pauseOnResize = !0), is_number(b.timeoutDuration) || (b.timeoutDuration = 10 > b.duration ? 2500 : 5 * b.duration), b.progress && (is_function(b.progress.bar) && (b.progress.bar = b.progress.bar.call(a)), is_string(b.progress.bar) && (b.progress.bar = jQuery(b.progress.bar)), b.progress.bar ? (is_function(b.progress.updater) || (b.progress.updater = $.fn.carouFredSel.progressbarUpdater), is_number(b.progress.interval) || (b.progress.interval = 50)) : b.progress = !1), b
    }
    ...
    function sz_storeMargin(a, b, c) {
        b.usePadding && (is_string(c) || (c = "_cfs_origCssMargin"), a.each(function () {
            var a = jQuery(this), d = parseInt(a.css(b.d.marginRight), 10);
    ...
    function sz_setResponsiveSizes(a, b) {
        ...
        b.each(function () {
            var b = jQuery(this), f = c - ms_getPaddingBorderMargin(b, a, "Width");
    ...
    $.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function (options, configs) {
        ...
        FN._init = function (a, b, c) {
            ...
            FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function (a, b) {
                ...
                var o = 0 > l ? opts.padding[opts.d[3]] : 0, p = !1, q = jQuery();
                ...
                N = function () {
                    if (P > 0 && ($cfs.children().slice(itms.total).remove(), g = jQuery($cfs.children().slice(itms.total - (opts.items.visible - P)).get().concat($cfs.children().slice(0, P).get()))), sc_showHiddenItems(p), opts.usePadding) {
                ...
                if (b = g[0], c = g[1], d = g[2], b instanceof $ && b.length > 1)return h = jQuery(), b.each(function () {
                    var a = $cfs.trigger(cf_e("removeItem", conf), [jQuery(this), c, d]);
                    a && (h = h.add(a))
                }), h;
                ...
                return h = c > b ? i.slice(b, c) : jQuery(i.slice(b, itms.total).get().concat(i.slice(0, c).get())), is_function(d) && d.call($tt0, h), h
                ...
                return a.stopPropagation(), is_undefined(b) ? b = jQuery("body") : is_string(b) && (b = jQuery(b)), is_jquery(b) && 0 != b.length ? (is_string(c) || (c = "a.caroufredsel"), b.find(c).each(function () {
                    var a = this.hash || "";
                    a.length > 0 && -1 != $cfs.children().index(jQuery(a)) && jQuery(this).unbind("click").click(function (b) {
                ...
                if (a.stopPropagation(), opts.pagination.container) {
                    ...
                    return e >= d && (e = 0), 0 > e && (e = d - 1), opts.pagination.container.each(function () {
                        jQuery(this).children().removeClass(cf_c("selected", conf)).eq(e).addClass(cf_c("selected", conf))
                    }), !0
                }
            ...
            ns3 = cf_e("", conf, !1, !0, !0), jQuery(document).unbind(ns3), jQuery(window).unbind(ns3), $wrp.unbind(a), opts.auto.button && opts.auto.button.unbind(a), opts.prev.button && opts.prev.button.unbind(a), opts.next.button && opts.next.button.unbind(a), opts.pagination.container && (opts.pagination.container.unbind(a), opts.pagination.anchorBuilder && opts.pagination.container.children().remove()), crsl.swipe && ($cfs.swipe("destroy"), $wrp.css("cursor", "default"), crsl.swipe = !1), crsl.mousewheel && (crsl.mousewheel = !1), nv_showNavi(opts, "hide", conf), nv_enableNavi(opts, "removeClass", conf)
    ...
    if (/iPhone|iPad|iPod/.test(navigator.platform) && /OS [1-5]_[0-9_]* like Mac OS X/i.test(e) && e.indexOf("AppleWebKit") > -1) {
        var f = a.document;
        if (f.querySelector) {
            var g, h, i, j, k = f.querySelector("meta[name=viewport]"), l = k && k.getAttribute("content"),
                m = l + ",maximum-scale=1", n = l + ",maximum-scale=10", o = !0;
...
var primp = {
    page: function () {
        foo("primp.page", 1);
        var a = jQuery(".navbar .dropdown-menu");
        a.find("*").on("click", function (b) {
            var c = jQuery(this);
            c.hasClass("regions-close") || c.hasClass("buttons-close") ? a.removeClass("open") : b.stopPropagation()
        });
        var b = jQuery(".planet-region");
        b.data("text", b.text());
        var c = jQuery(".img-map");
        c.find("area").on("click mouseenter mouseleave focus focusout", function (a) {
            var d = jQuery(this), e = d.attr("title");
            "mouseenter" == a.type || "focus" == a.type ? b.text(e) : "mouseleave" == a.type || "focusout" == a.type ? b.text(b.data("text")) : "click" == a.type && (b.text(e).data("text", e + " selected"), c.attr("class", "img-map " + d.attr("data-parentClass")))
        });
        var d = jQuery(".languages a");
        jQuery(".languages a").on("click", function () {
            d.removeClass("active"), jQuery(this).addClass("active")
        }), setDropdownHeight(), closeNav(), jQuery(".clickable").clickable(), jQuery("input, textarea").placeholder();
        var e = primp[jQuery("body")[0].getAttribute("data-templateJS")];
        "function" == typeof e && e()
    }, loadComplete: function (a) {
        foo("primp.loadComplete");
        var b = jQuery(a);
        b.find(".clickable").clickable(), b.find("input, textarea").placeholder()
    }, homepage: function () {
        function a() {
            jQuery("#carousel").carouFredSel({
                width: "100%",
                items: {visible: 3, start: -1},
                scroll: {items: 1, duration: 1e3, timeoutDuration: 3e3},
                prev: ".carousel-prev",
                next: ".carousel-next"
            })
        }

        foo("primp.homepage", 1), a()
    }, calendar: function () {
        foo("primp.calendar", 1), jQuery(".torso .nav-tabs a:first").tab("show");
        var a = {
            dayLabels: ["S", "M", "T", "W", "T", "F", "S"],
            monthLabels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
            daysInMonth: [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
            generateYearHTML: function (b) {
                foo("calendarBuilder.generateYearHTML", 1);
                var c = new Date, d = '<table class="table months">';
                d += "<tr>";
                for (var e = 0; e <= a.monthLabels.length - 1; e++) {
                    var f = a.monthLabels[e].slice(0, 3);
                    d += "<th", c.getMonth() === e && (d += ' class="active"'), d += ">", d += '<a href="#' + f + b + '" data-toggle="tab">', d += f, d += "</a>", d += "</th>"
                }
                d += "</tr>", d += "</table>";
                for (var g = "", e = 0; 12 > e; e++)g += a.generateMonthHTML(b, e);
                var h = d;
                return h += '<div class="tab-content">', h += g, h += "</div>"
            },
            generateMonthHTML: function (b, c) {
                foo("calendarBuilder.generateMonthHTML", 1);
                var d = new Date(b, c, 1), e = d.getDay(), f = a.daysInMonth[c];
                1 == c && (b % 4 == 0 && b % 100 != 0 || b % 400 == 0) && (f = 29);
                var g = new Date, h = '<div class="tab-pane';
                g.getMonth() === c && (h += " active"), h += '" id="' + a.monthLabels[c].slice(0, 3) + b + '">', h += '<table class="table days">', h += "<thead>", h += "<tr>";
                for (var i = 0; 6 >= i; i++)h += "<th>", h += a.dayLabels[i], h += "</th>";
                h += "</tr>", h += "</thead>", h += "<tbody>", h += "<tr>";
                for (var j = 1, i = 0; 9 > i; i++) {
                    for (var k = 0; 6 >= k; k++)h += "<td", f >= j && (i > 0 || k >= e) ? (h += ' id="day' + b, h += 10 > c + 1 ? "0" + (c + 1) : c + 1, h += 10 > j ? "0" + j : j, h += '"><span>' + j + "</span>", j++) : h += ">", h += "</td>";
                    if (j > f)break;
                    h += "</tr>", h += "<tr>"
                }
                return h += "</tr>", h += "</table>", h += "</div>"
            }
        }, b = {
            loadYear: function (a) {
                foo("calendarLoader.loadYear", 1), $.ajax({
                    dataType: "json",
                    url: "../scripts/calendar-data.json?year=" + a,
                    success: function (a) {
                        a.events.length && b.markCalendar(a)
                    }
                })
            }, markCalendar: function (b) {
                foo("calendarLoader.markCalendar", 1), $.each(b.events, function (b, c) {
                    var d = c.start, e = c.end,
                        f = d.slice(6, 8) + " " + a.monthLabels[1 * d.slice(4, 6) - 1] + " " + d.slice(0, 4),
                        g = d.slice(0, 4) + "/" + d.slice(4, 6) + "/" + d.slice(6, 8),
                        h = e.slice(0, 4) + "/" + e.slice(4, 6) + "/" + e.slice(6, 8),
                        i = '<div class="row"><div class="col-xs-12"><h3>' + f + "</h3></div></div>",
                        j = '<div class="row has-border">';
                    "" != c.image ? (j += '<div class="col-xs-3">', j += '<img src="' + c.image + '" />', j += "</div>", j += '<div class="col-xs-9">') : j += '<div class="col-xs-12">', j += "<h4>" + c.title + "</h4>", j += "<h5>" + g + " - " + h + "</h5>", j += "<p>" + c.desc + "</p>", j += '<p><a class="cta-red" href="' + c.url + '">More info</a></p>', j += "</div>", j += "</div>";
                    for (var b = d; e >= b; b++) {
                        var k = jQuery("#day" + b);
                        if (k.find("a").length)var l = k.find("a"); else var l = k.html('<a href="#day' + b + '">' + k.find("span").text() + "</a>").find("a");
                        if (void 0 == l.data("eventHTML")) l.data("eventHTML", i + j); else {
                            var l = k.find("a");
                            l.data("eventHTML", l.data("eventHTML") + j)
                        }
                        l.on("click", function (a) {
                            a.preventDefault();
                            var b = jQuery(this);
                            b.closest(".calendar-element").find(".days .active").removeClass("active"), b.addClass("active"), jQuery(".calendar-event-info").html(b.data("eventHTML"))
                        })
                    }
                })
            }
        }, c = jQuery(".calendar-parent");
        c.find(".dropdown-menu a").on("click", function (c) {
            c.preventDefault();
            var d = jQuery(this), e = d.text();
            d.closest(".dropdown").find("a:first").html(e + ' <span class="glyphicon glyphicon-chevron-down"></span>'), jQuery(".calendar-element").html(a.generateYearHTML(e));
            var f = jQuery(".months");
            f.find("a").on("click", function () {
                f.find(".active").removeClass("active"), jQuery(this).parent().addClass("active")
            }), b.loadYear(e)
        }).first().click()
    }, myLocalMurata: function () {
        foo("primp.myLocalMurata", 1), map.create("map-small"), map.create("map-large")
    }, map: function () {
        foo("primp.map", 1), map.create("map-large")
    }
};
