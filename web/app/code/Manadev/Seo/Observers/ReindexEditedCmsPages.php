...
class ReindexEditedCmsPages implements ObserverInterface
{
    /**
     * @var IndexerRegistry
     */
    ...
    public function execute(Observer $observer) {
        ...
        if (!$indexer->isScheduled()) {
            $cmsPageId = $observer->getData('data_object')->getId();
            $rewriteIds = $this->indexerResource->getUrlRewriteIdsByCmsPageId($cmsPageId);
            if (!empty($rewriteIds)) {
