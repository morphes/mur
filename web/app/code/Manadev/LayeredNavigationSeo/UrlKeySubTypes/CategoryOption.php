...
use Manadev\LayeredNavigationSeo\Resources\SeoUrlKeyIndexers\CategoryOptionIndexer;
...
class CategoryOption extends UrlKeySubTypeHandler
{
    /**
     * @var CategoryOptionIndexer
     */
    protected $indexer;

    public function __construct(CategoryOptionIndexer $indexer) {
    ...
    public function getSubType() {
        return UrlKeySubType::CATEGORY_OPTION;
    }
