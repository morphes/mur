 ...
 * @since 100.0.2
 */
class SeriesAbstract extends \Magento\Framework\View\Element\Template
{
    ...
    public function getSeriesStatuses($product)
    {
    ...
    public function getSeriesCollection($seriesType)
    {
        ...
        $collection
            ...
            joinTable(
                ['series_type_value' => 'eav_attribute_option_value'],
                'option_id = series_type', ['series_type_value' => 'value']
            )
            ->addAttributeToFilter('series_type_value', ['like' => '%'.$seriesType.'%'])
