                ...
                if ($settings['list_key']) {
                    if ($urlKey == $settings['list_key']) {
                        ...
                        if ($settings['cat_prefix']) {
                            ...
                            if(count($catPrefix) > 2) {
                                $catPrefixCheck = explode('/', $settings['cat_prefix']);
                                if(count($catPrefixCheck) > 1) {
                                    if($catPrefix[0] == $catPrefixCheck[0] && $catPrefix[1] == $catPrefixCheck[1]) {
                                        unset($catPrefix[0]);
                                        unset($catPrefix[1]);
                                        $catPath = true;
                                        $urlKeyCat = implode('/', $catPrefix);
                                    }
                                }
