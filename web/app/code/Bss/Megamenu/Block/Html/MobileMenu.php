...
use Murata\Theme\Block\Html\Dropdown;

class MobileMenu extends Template
{
    /**
    ...
    protected function _getChildHtmlCatagoryListSecond($menu, $collection, $html, $menu2, $size, $countCollection)
    {
        ...
        foreach ($menu->children as $childrens) {
            ...
            $html .= '<li><a class="parent '.$parentActiveClass.' menu-link-'.$collection[$childrens->id]['category_id'].'" data-id="'.$collection[$childrens->id]['category_id'].'" href="'.$this->helper->getLinkUrl($collection[$childrens->id]).'">';
            $html .= $childrens->text;
            ...
            if (isset($childrens->children[0])) {
                ...
                foreach ($childrens->children as $child) {
                    ...
                    $html .= '<li><a href="'.$this->helper->getLinkUrl($collection[$child->id]).'" class="children'.$activeClass.'"><span>';
