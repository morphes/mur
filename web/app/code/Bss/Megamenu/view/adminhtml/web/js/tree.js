...
define([
    ...
    $.widget('bss.bss_config', {
        _create: function () {
            ...
            var adminFieldBssTargetBlank = $(".admin__field.bss_target_blank");
            ...
            $(document).ready(function() {
                $(document).on("change", "select#megamenu_menu_url_type", function() {
                    ...
                    switch (menuType) {
                        case '1':
                            ...
                            $(".admin__field.bss_target_blank").show();
                            $(".admin__field.bss_category_link").hide();
                            break;
                        case '0':
                            $(".admin__field.bss_custom_link").hide();
                            $(".admin__field.bss_target_blank").hide();
                ...
                $(document).on("change", "select#megamenu_type", function() {
                    ...
                    switch (menuType) {
                        case '1':
                            $(".admin__field.bss_columns_count").hide();
                            $(".admin__field.bss_target_blank").hide();
                            ...
                            break;
                        case '2':
                            $(".admin__field.bss_columns_count").show();
                            $(".admin__field.bss_target_blank").show();
                            $(".admin__field.bss_content_block").hide();
                        ...
                        success: function(response) {
                            ...
                            if(response.empty) {
                                ...
                                var newMenuKO = megamenuKO(
                                    ...
                                    response.type,
                                    response.label,
                                    response.content.columns_count,
                                    response.content.target_blank,
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var newMenuKO = megamenuKO(
                            ...
                            response.type,
                            response.label,
                            response.columns_count,
                            response.target_blank,
                            response.content.megamenu_static_block_top,
                            response.content.megamenu_static_block_right,
                            response.content.megamenu_static_block_bottom,
                            response.content.megamenu_static_block_left,
            ...
            function megamenuKO(
                ...
                self.columnsCount = ko.observable(columns_count);
                self.targetBlank = ko.observable(target_blank);
