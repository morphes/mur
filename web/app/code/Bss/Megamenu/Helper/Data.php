...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getLinkUrl($menu)
    {
        ...
        switch ($menu['url_type']) {
            ...
            case 0:
                if($menu['category_id'] == 247) {
                    return '/contact-us.html';
                }
                if(in_array($menu['category_id'], [40,244,246,247,249,113])) {
                    $category = $this->categoryRepository
                        ->get($menu['category_id'], $this->storeManager->getStore()->getId());
                    return $category->getUrl();
                }
                if(isset($menu['type']) == self::CATEGORY_LISTING_TYPE && $menu['columns_count'] && $menu['category_id'] != '' && $menu['category_id'] > 0) {
                    return '/';
                }
