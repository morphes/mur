 ...
 */
namespace Bss\CmsPageImportExport\Controller\Adminhtml\Import;
...
{
    const URL_REWRITE_SAMPLE_FILE = 'Bss_CmsPageImportExport';
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getParam('filename') == 'bss_cms_page') {
    ...
    {
        return $this->_authorization->isAllowed('Bss_CmsPageImportExport::importexport_cms_page_import');
    }
}
