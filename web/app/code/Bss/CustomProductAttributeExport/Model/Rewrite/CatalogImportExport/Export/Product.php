...
if (class_exists(\Bss\ProductLabel\Plugin\CatalogImportExport\Export\Product::class)) {
	class ProductExport extends \Bss\ProductLabel\Plugin\CatalogImportExport\Export\Product { }
} else {
	class ProductExport extends \Magento\CatalogImportExport\Model\Export\Product { }
}
