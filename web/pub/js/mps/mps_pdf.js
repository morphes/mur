...
//	else if(navigator && (navigator.userAgent.toLowerCase()).indexOf("msie") > -1) browser_info.name = "ie";
    ...
    else if(/trident/i.test(M[1])) browser_info.name = "ie";
	...
	try
	{
		...
		else if(browser_info.name == "firefox")
		{
			...
			for(key in navigator.plugins)
			{
				...
				{
					browser_info.acrobat = "installed";
					browser_info.acrobat_ver = parseInt(navigator.plugins[key].version) || "Adobe Acrobat";
	//				alert("s");
				}
			} 
		}
...
//browser_info.acrobat_ver = parseFloat(version[0][1]);
//alert(browser_info.acrobat_ver);
// for Firefox
var minadobeversion1d = /1\d/.test(browser_info.acrobat_ver);
...
var minadobeversion14 = /14\..+/.test(browser_info.acrobat_ver);
var minadobeversion15 = /15\..+/.test(browser_info.acrobat_ver);
var minadobeversion16 = /16\..+/.test(browser_info.acrobat_ver);
var minadobeversion17 = /17\..+/.test(browser_info.acrobat_ver);
var minadobeversion18 = /18\..+/.test(browser_info.acrobat_ver);
var minchrome = /Chrome.+/.test(browser_info.acrobat_ver);
if(minadobeversion1d == true || minadobeversion10 == true || minadobeversion11 == true || minadobeversion12 == true || minadobeversion13 == true || minadobeversion14 == true || minadobeversion15 == true || minadobeversion16 == true || minadobeversion17 == true || minadobeversion18 == true  || minchrome == true || isMobile.any())
	{	
//	alert("iffff");
	}
else {
